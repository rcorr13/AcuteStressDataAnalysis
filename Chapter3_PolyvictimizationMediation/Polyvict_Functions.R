...
# creates sample demographics table with race divided as was suggested by Reviewer 2
SampleDemographicsReviewer2 <- function(df) {
  ...
  demographics["DSM-IV Diagnosis"] = label_percent()(as.vector(table(df$SCIDNum)['Yes'])/N)
